/* ==========================================================================
   Vintage 101 Marketplace: Content Manager (admin SPA)
...
(function () {
  ...
  function showFatal(msg) {
    ...
    $app.appendChild(el("main", { class: "auth-wrap", id: "main" }, [
      el("div", { class: "auth-card" }, [
        el("p", { class: "auth-mark" }, "Vintage 101"),
  ...
  function loadDashboard() {
    ...
    $app.appendChild(el("div", { class: "boot", role: "status" }, [
      el("div", { class: "boot-mark" }, "Vintage 101"),
  ...
  function ensureShape(c) {
    ...
    ["marketplace", "records", "chocolate", "furniture", "art"].forEach(function (k) {
      c.sections[k] = c.sections[k] || {};
    });
    ["marketplace", "furniture", "art"].forEach(function (k) {
      c.sections[k].cards = c.sections[k].cards || [];
    });
    c.sections.records.cta = c.sections.records.cta || {};
    c.sections.records.images = c.sections.records.images || [];
    c.vendors = c.vendors || {}; c.vendors.items = c.vendors.items || [];
  ...
  var PANELS = [
    ...
    { id: "marketplace", label: "Marketplace", group: "Sections", render: function (m) { return panelCardSection(m, "marketplace", "The marketplace"); } },
    { id: "records", label: "Records (Wax Museum)", group: "Sections", render: panelRecords },
    { id: "chocolate", label: "Chocolate", group: "Sections", render: panelChocolate },
    { id: "furniture", label: "Furniture", group: "Sections", render: function (m) { return panelCardSection(m, "furniture", "Furniture department"); } },
    { id: "art", label: "Art and collectibles", group: "Sections", render: function (m) { return panelCardSection(m, "art", "Art and collectibles"); } },
    { id: "vendors", label: "Vendors", group: "Pages", render: panelVendors },
  ...
  function renderDashboard() {
    ...
    var actionbar = el("header", { class: "actionbar" }, [
      el("div", { class: "brand" }, [el("span", null, "Vintage 101"), el("span", { class: "hint", style: "color:var(--ink-faint);font-weight:600" }, "Content Manager")]),
  ...
  function panelSite() {
    ...
    return panelShell("Site and contact", "The shop name, contact details, hours, and social links that appear across the site.", el("div", null, [
      ...
      textField("Wax Museum Records Instagram", s, "waxMuseumInstagram", { type: "url" }),
  ...
  function panelHero() {
    ...
    return panelShell("Hero (top of page)", "The big opening area at the top of the home page.", el("div", null, [
      ...
      el("div", { class: "grid-2" }, [
        ...
        textField("Button link", h.ctaPrimary, "href", { hint: "A page like records.html or a full web link." }),
      ]),
  ...
  function panelStats() {
    ...
    return panelShell("Stat highlights", "The short value and label pairs shown as highlights, like 20+ curated vendors.", listEditor({
      items: items,
      ...
      makeRow: function (it) {
        return el("div", { class: "grid-2" }, [
          textField("Value", it, "value", { hint: "For example: 20+ or Daily." }),
          textField("Label", it, "label", { hint: "For example: curated vendors." }),
        ]);
      },
    }));
  }
  ...
  // ======================================================================
  //  PANEL: GENERIC CARD SECTION (marketplace, furniture, art)
  // ======================================================================
  ...
  // ======================================================================
  //  PANEL: RECORDS (body + cta + two images)
  // ======================================================================
  function panelRecords() {
    var sec = state.content.sections.records;
    sec.cta = sec.cta || {};
    sec.images = sec.images || [];
    return panelShell("Records (Wax Museum)", "The Wax Museum Records section. It has a write up, a follow button, and two photos.", el("div", null, [
      textField("Number", sec, "num"),
      textField("Eyebrow", sec, "eyebrow"),
      textField("Title", sec, "title"),
      textField("Body", sec, "body", { textarea: true, rows: 4 }),
      el("div", { class: "subhead" }, "Follow button"),
      el("div", { class: "grid-2" }, [
        textField("Button label", sec.cta, "label"),
        textField("Button link", sec.cta, "href", { type: "url" }),
      ]),
      el("div", { class: "subhead" }, "Photos"),
      listEditor({
        items: sec.images,
        addLabel: "Add a photo",
        titleOf: function (it, i) { return "Photo " + (i + 1); },
        newItem: function () { return { id: uid("r"), image: "", alt: "" }; },
        makeRow: function (it) { return imageField("Photo", it, "image", it, "alt"); },
      }),
    ]));
  }
  ...
  //  PANEL: CHOCOLATE
  // ======================================================================
  function panelChocolate() {
    var sec = state.content.sections.chocolate;
    return panelShell("Chocolate", "The handmade chocolate section with one photo.", el("div", null, [
      textField("Number", sec, "num"),
      textField("Eyebrow", sec, "eyebrow"),
      textField("Title", sec, "title"),
      textField("Body", sec, "body", { textarea: true, rows: 4 }),
  ...
  //  PANEL: VENDORS
  // ======================================================================
  function panelVendors() {
    var v = state.content.vendors;
    v.items = v.items || [];
    return panelShell("Vendors", "The list of vendors and booths shown on the vendors page. Add, edit, remove, or reorder them freely.", el("div", null, [
      textField("Intro paragraph", v, "intro", { textarea: true, rows: 3 }),
      el("div", { class: "subhead" }, "Vendor list"),
      listEditor({
        items: v.items,
        addLabel: "Add a vendor",
        titleOf: function (it) { return it.name || "New vendor"; },
        deleteMsg: "This removes the vendor from your vendors page when you publish.",
        newItem: function () { return { id: uid("v"), name: "", category: "", description: "", image: "", alt: "", social: "" }; },
        makeRow: function (it) {
          return el("div", null, [
            el("div", { class: "grid-2" }, [
              textField("Name", it, "name"),
              textField("Category", it, "category", { hint: "For example: Records, Furniture, Jewelry." }),
            ]),
            textField("Description", it, "description", { textarea: true, rows: 3 }),
            textField("Social link (optional)", it, "social", { type: "url", hint: "Leave empty if there is none." }),
            imageField("Vendor photo", it, "image", it, "alt"),
          ]);
        },
      }),
    ]));
